...
using Android.Views;
using CallOfService.Technician.Mobile;
using CallOfService.Technician.Mobile.Droid.Renderers.Calendar;
using Xamarin.Forms;
...
namespace CallOfService.Technician.Mobile.Droid.Renderers.Calendar
{
