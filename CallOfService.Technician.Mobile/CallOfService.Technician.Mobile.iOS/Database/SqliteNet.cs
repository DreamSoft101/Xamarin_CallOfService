...
namespace CallOfService.Technician.Mobile.iOS.Database
{
    public class SqliteNet :  ISqLiteNet
    {
        ...
        {
            return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Personal), "CallOfService.Technician.Mobile.db3");
        }
